...
<html>
    ...
    <body>
        ...
        <div id="pop_im1" title="Imagen slider 1">
            ...
            <input type="text" name="tit1" id="tit1" size="30" value="<?= $img[1] ?>" maxlength="12"/>
            <br>
            <label for="des1">Descripcion: </label>
            <textarea name="des1" id="des1" rows="5" cols="30" maxlength="40"><?= $img[2] ?></textarea>
            <br>
        ...
        <div id="pop_im2" title="Imagen slider 2">
            ...
            <input type="text" name="tit2" id="tit2" size="30" value="<?= $img[4] ?>" maxlength="12"/>
            <br>
            <label for="des2">Descripcion: </label>
            <textarea name="des2" id="des2" rows="5" cols="30" maxlength="40"><?= $img[5] ?></textarea>
            <br>
        ...
        <div id="pop_titulo" title="Empresa">
            <form id="form_titulo">
                ...
                <input type="text" name="titulo" id="titulo" size="30" value="<?= $row['titulo'] ?>"/>
                <label for="desctitulo">Descripcion: </label><br>
                <textarea name="desctitulo" id="desctitulo" rows="5" cols="30" ><?= $row['desctitulo'] ?></textarea>    
            </form>
        ...
        <div id="main-container">
            ...
            <!--div id="file-uploader">
                <div id="slider">
                    <img src="../imagenes/" id="imagen1_destino">
                </div>
            </div-->
